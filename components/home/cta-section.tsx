      ...
      <Container>
        <FadeIn>
          <NeonGlow className="rounded-[var(--radius-xl)]" color="green">
            <div className="glass-panel neon-card glitch-hover hero-gradient-shell cyber-grid relative overflow-hidden rounded-[var(--radius-xl)] border border-border/80 px-6 py-12 shadow-[var(--shadow-md)] md:px-10 md:py-16 lg:px-16">
