...
export function Hero() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,var(--color-accent-soft),transparent_32%),radial-gradient(circle_at_80%_20%,var(--color-accent-glow),transparent_22%)]"
      />
      <div
        aria-hidden="true"
      ...
      <Container className="relative max-w-[var(--container-wide)]">
        <Parallax speed={0.12} className="grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.9fr)] lg:items-center lg:gap-16">
          <div className="max-w-4xl">
            ...
            <Heading as="h1" size="display-xl" className="max-w-5xl text-balance leading-none">
              <TextReveal className="block">Shaeel Afsar</TextReveal>
            </Heading>
            <FadeIn delay={0.5} className="mt-8 max-w-2xl">
          ...
          <div aria-hidden="true" className="hidden lg:block">
            <Parallax speed={0.3} className="relative mx-auto aspect-[4/5] max-w-md">
              <div className="absolute inset-0 rounded-[var(--radius-xl)] border border-border/80 bg-[linear-gradient(160deg,color-mix(in_srgb,var(--color-card)_82%,transparent),transparent_70%)] shadow-[var(--shadow-lg)] backdrop-blur-[var(--blur-md)]" />
              ...
              <div className="absolute left-10 top-1/3 right-10 rounded-[var(--radius-lg)] border border-border bg-card/80 p-6 shadow-[var(--shadow-md)]">
              ...
              <div className="absolute bottom-10 right-0 w-56 rounded-[var(--radius-lg)] border border-border bg-card/80 p-5 shadow-[var(--shadow-md)]">
